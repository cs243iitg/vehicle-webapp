    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_security', models.BooleanField(default=False, verbose_name='Is security personnal', help_text='Designates whether this user is security personnal or not.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vehicle_type', models.CharField(max_length=50, choices=[('bicycle', 'bicycle'), ('bike', 'bike'), ('car', 'car'), ('truck', 'truck'), ('courier', 'courier'), ('auto', 'auto'), ('other', 'other')], blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registered_with_security_section', models.BooleanField()),
                ('vehicle_pass_no', models.CharField(max_length=32, blank=True, null=True)),
                ('user', models.ForeignKey(to='vms.IITGUser')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reporter', models.ForeignKey(to='vms.IITGUser')),
            ],
        ),
        migrations.CreateModel(
            name='TheftReport',
            fields=[
                ('id', models.AutoField(verbose_name='ID', primary_key=True, serialize=False, auto_created=True)),
                ('registration_number', models.CharField(max_length=50)),
                ('vehicle_type', models.CharField(max_length=50, choices=[('bicycle', 'bicycle'), ('bike', 'bike'), ('car', 'car'), ('truck', 'truck'), ('courier', 'courier'), ('auto', 'auto'), ('other', 'other')], null=True)),
                ...
                ('reporter', models.ForeignKey(to='vms.IITGUser', null=True, blank=True)),
            ],
        ),
        migrations.CreateModel(
            name='VehiclePass',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('in_gate', models.ForeignKey(to='vms.Gate', related_name='in_gate_log', null=True)),
                ('out_gate', models.ForeignKey(to='vms.Gate', related_name='out_gate_log', null=True)),
            ],
        ),
        migrations.AddField(
            model_name='gate',
