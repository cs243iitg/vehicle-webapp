    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_student', models.BooleanField(default=False, help_text='Designates whether the user is a student or a professor.', verbose_name='student_or_professor')),
                ('is_security', models.BooleanField(default=False, help_text='Designates whether this user is security personnal or not.', verbose_name='security_personnal')),
            ],
            options={
                'abstract': False,
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reporter', models.ForeignKey(blank=True, to='vms.IITGUser', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='VehiclePass',
