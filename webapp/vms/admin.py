...
from vms.models import StudentVehicle, Guard, Gate, ParkingSlot, SuspiciousVehicle, ResidentLog, VisitorLog, TheftReport
...
class ParkingSlotAdmin(admin.ModelAdmin):
    model = ParkingSlot
    list_display = ('parking_slot_name', 'total_slots', 'available_slots', 'security_on_duty')
